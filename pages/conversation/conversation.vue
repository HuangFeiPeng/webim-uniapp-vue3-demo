...
//   onLoad() {
//     conversationState.getWindowSize();
//     //监听加好友申请
//     disp.on('em.subscribe', conversationState.onChatPageSubscribe);
//     //监听解散群
//     disp.on('em.invite.deleteGroup', conversationState.onChatPageDeleteGroup);
//     //监听未读消息数
//     disp.on('em.unreadspot', conversationState.onChatPageUnreadspot);
//     //监听未读加群“通知”
//     disp.on('em.invite.joingroup', conversationState.onChatPageJoingroup);
//     //监听好友删除
//     disp.on('em.contacts.remove', conversationState.onChatPageRemoveContacts);
//     //监听好友关系解除
//     disp.on('em.unsubscribed', conversationState.onChatPageUnsubscribed);
//     if (!uni.getStorageSync('listGroup')) {
//       conversationState.listGroups();
//     }
//     if (!uni.getStorageSync('member')) {
//       conversationState.getRoster();
//     }
//     conversationState.readJoinedGroupName();
//   },

//   onShow: function () {
//     uni.hideHomeButton && uni.hideHomeButton();
//     setTimeout(() => {
//       conversationState.getLocalConversationlist();
//     }, 100);
//     conversationState.setData({
//       unReadSpotNum:
//         getApp().globalData.unReadMessageNum > 99
